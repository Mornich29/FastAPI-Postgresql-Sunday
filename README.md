...
2. Create the virtual environment and install the required packages (You can find the packages in requirements.txt)
3. activate the environment
4. type "uvicorn main:app --reload" in the command line to start.
5. Now you can access to the localhost:8000 (use localhost:8000/docs to try the functions )
